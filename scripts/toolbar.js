...
$( document ).ready(function() {
    ...
    if (toolbar_pop_fontsize) {
        toolbar_pop_fontsize.addEventListener('mouseover', function () {
            ...
            modal = document.getElementById('Ribbon_fontSize_popup_list_wrapper');
            ...
            ul =  document.getElementById('Ribbon_fontSize_popup');
    ...
    if (toolbar_pop_fontfamily) {
        toolbar_pop_fontfamily.addEventListener('mouseover', function () {
            ...
            modal = document.getElementById('Ribbon_fontFamily_popup_list_wrapper');
            ...
            //modal.style.width =  toolbar_fontsize.offsetWidth +  'px';
            // ul =  document.getElementById('Ribbon_fontfamily_popup');
            // ul.style.width =  toolbar_fontsize.offsetWidth +  'px';
        });
    }
...
$('#toolbar_fontSize_dropdown').click(function(){
    $('#Ribbon_fontSize_popup_list_wrapper').fadeIn();
});

$('#toolbar_fontfamily_dropdown').click(function(){
    $('#Ribbon_fontFamily_popup_list_wrapper').fadeIn();
});
...
{
    toolbar_pop_fontsize_1 = document.getElementById('Ribbon_fontSize_popup_list_wrapper');
    toolbar_pop_fontsize_2 = document.getElementById('toolbar_fontSize_wrapper');
    toolbar_pop_fontsize_3 = document.getElementById('Ribbon_home_Format_fontSize');
    if(!toolbar_pop_fontsize_1.contains(event.target) && !toolbar_pop_fontsize_2.contains(event.target)  && !toolbar_pop_fontsize_3.contains(event.target))
    {
        $('#Ribbon_fontSize_popup_list_wrapper').fadeOut();
    }

    var toolbar_pop_fontfamily_1 = document.getElementById('Ribbon_fontFamily_popup_list_wrapper');
    var toolbar_pop_fontfamily_2 = document.getElementById('toolbar__fontfamily');
    var toolbar_pop_fontfamily_3 = document.getElementById('Ribbon_fontFamily_wrapper');
    if(!toolbar_pop_fontfamily_1.contains(event.target) && !toolbar_pop_fontfamily_2.contains(event.target) && !toolbar_pop_fontfamily_3.contains(event.target))
    {
        $('#Ribbon_fontFamily_popup_list_wrapper').fadeOut();
    }
